...
if __name__ == '__main__':
    ...
    test_data_unflipped = load_train_data(TEST_PATH)
    
    flipped = torch.flip(test_data_unflipped[:][0], (3,))
    test_data = torch.utils.data.TensorDataset(flipped, test_data_unflipped[:][1])
    ...
    save_path = os.path.join(artifact_path, attack.attack.__class__.__name__+'_mixed_mirrored_data')
